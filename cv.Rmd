...
My supervisor Romina Rader has two main projects and I will collaborate with her indistinctly in both of them. All of them are about crop pollination, and the crops where I'm going to work are: apple, raspberry, blueberry, mango and melon. Notwithstanding some other crops can be included in function of our preferences of research.
...
Worked for two months at Mario Vallejo's lab helping with greenhouse experiment and fieldwork at Shetland Island and Stirling.

`2012-14`
__Intern student__(_University of Seville, Spain_)
Two years in the department of Plant Science with Juan Arroyo. Mainly, I create a database using Web Of Science with several characteristic of heterostily plants. 

-----

This CV has been done with R Markdown. An online version of it is available [__on my github account__](https://github.com/JoseBSL/md-cv) ![](githublogo.png){ width=2.5% }
